      ...
      <Modal open={open} onClose={() => setOpen(false)}>
        <div style={modalStyle} className={classes.paper}>
          <form className="app__login">
            ...
            />
            <Button className="app__login__button" variant="outlined" color="primary" onClick={handleLogin}>Login</Button>
          </form>
        </div>
      </Modal>
        ...
        <div style={modalStyle} className={classes.paper}>
          <form className="app__login">
            ...
            <Input
              ...
              onChange={(e) => setPassword(e.target.value)}
            />
            <Button className="app__login__button" variant="outlined" color="primary" onClick={handleRegister}>Register</Button>
          </form>
        </div>
      </Modal>
